...
return [
    ...
    */
    ...
    'custom' => [
        'kode_badan_usaha.*' => [
            'required' => 'Kode Badan Usaha wajib diisi',
        ],
        'no_kk.*' => [
            'required' => 'No KK wajib diisi',
            'max' => 'No KK maksimal berisi :max karakter.'
        ],
        'nik_kitas_kitap.*' => [
            'required' => 'NIK / KITAS / KITAP wajib diisi',
            'max' => 'NIK / KITAS / KITAP maksimal berisi :max karakter.'
        ],
        'nama_lengkap.*' => [
            'required' => 'Nama Lengkap wajib diisi',
        ],
        'pisat.*' => [
            'required' => 'PISAT wajib diisi',
        ],
        'nama_faskes_tingkat_pertama.*' => [
            'required' => 'Nama Faskes Tingkat Pertama wajib diisi',
        ],
        'nama_faskes_dokter_gigi.*' => [
            'required' => 'Nama Faskes Dokter Gigi wajib diisi',
        ],
        'no_handphone.*' => [
            'required' => 'No Handphone wajib diisi',
            'min' => 'No Handphone minimal berisi :min karakter',
            'max' => 'No Handphone minimal berisi :max karakter',
        ],
        'email.*' => [
            'required' => 'Email Wajib diisi',
        ],
        'gaji_pokok_tunjangan_tetap.*' => [
            'required' => 'Gaji Pokok + Tunjangan Tetap wajib diisi',
        ],
